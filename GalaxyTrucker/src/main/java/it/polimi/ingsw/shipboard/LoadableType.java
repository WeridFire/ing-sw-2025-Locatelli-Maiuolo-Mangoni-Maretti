...
public enum LoadableType {
    ...
    /** An unmodifiable set containing all kinds of goods. */
    public static final Set<LoadableType> GOODS_SET = Set.of(RED_GOODS, YELLOW_GOODS, GREEN_GOODS, BLUE_GOODS, BATTERY);
